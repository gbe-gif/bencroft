...
export function GalleryTab() {
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-[#c5a059]/30 pt-12 pb-8">
        <div className="flex flex-col items-center justify-center text-center">
          {!isUnlocked ? (
            <div className="border border-[#c5a059]/30 bg-[#152820]/40 p-8 max-w-md w-full relative overflow-hidden">
              ...
              <h2 className="text-xl font-serif text-[#c5a059] mb-2 tracking-tight">시크릿 갤러리</h2>
            ...
            <div className="w-full">
              <div className="mb-8 flex items-center justify-center gap-3">
                <Unlock className="w-5 h-5 text-[#c5a059]" />
                <h2 className="text-2xl font-serif text-[#c5a059] tracking-tight">시크릿 갤러리</h2>
              </div>
